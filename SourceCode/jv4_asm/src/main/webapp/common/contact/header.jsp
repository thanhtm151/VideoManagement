				...
				<li class="nav-item"><a class="nav-link nav-link-1 active"
				  ...
				  <li class="nav-item dropdown">
			          ...
			          <ul class="dropdown-menu dmenu-design" aria-labelledby="taiKhoan">
			            <li><a class="dropdown-item" href="/ASM_Java45/login" ${login_pass}>Đăng nhập</a></li>			           
...
<div class="tm-hero3 justify-content-center align-items-center"
	data-parallax="scroll"
	data-image-src="<c:url value='/templates/user/img/bg2.jpg'/>">
</div>